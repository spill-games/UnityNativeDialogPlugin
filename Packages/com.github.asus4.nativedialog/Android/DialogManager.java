...
public class DialogManager {
    ...
    /**
     * Parses HTML in the dialog message and enables tappable hyperlinks.
     * Supports <a href="url">text</a> anchor tags as well as auto-detected plain URLs.
     */
    @SuppressWarnings("deprecation")
    private void applyHtmlLinks(AlertDialog alertDialog, String msg) {
        TextView messageView = alertDialog.findViewById(android.R.id.message);
        if (messageView == null) {
            return;
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            messageView.setText(Html.fromHtml(msg, Html.FROM_HTML_MODE_LEGACY));
        } else {
